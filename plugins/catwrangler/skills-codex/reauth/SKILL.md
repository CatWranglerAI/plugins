...
If the human asks to sign in from their phone, go straight to "Signing in from a phone" below.
...
1. Start the sign-in:
   ...
   ```
   sh "../../scripts/remote-login.sh" codex start
   ```
...
2. Wait for the approval:
   ...
   ```
   sh "../../scripts/remote-login.sh" codex wait
   ```
